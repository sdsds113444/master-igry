      ...
      <div className="grid gap-6 lg:grid-cols-[1.5fr_1fr]">
        ...
        <section className="space-y-4">
          ...
          <div className="glass rounded-glass p-5">
            ...
            {/* Команды вставляли сюда готовые ответы, приняв чат за форму сдачи, — подписываем,
                где на самом деле сдавать. Формулировка не зависит от того, идёт ли игра. */}
            <p className="mt-2 text-xs text-ink-soft">
              Чат для обсуждения. <b>Ответы сюда не отправляются</b> — их сдают в блоке
              «Ответ команды» кнопкой «Отправить тренеру».
            </p>
