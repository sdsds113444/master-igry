  ...
  return (
    ...
    >
      <div className="flex min-h-0 flex-1 flex-col p-4 pt-2">
        ...
        />
        {/* Тренеру тоже присылали сюда сами ответы — подписываем, где их сдавать. */}
        {!asAdmin && (
          <p className="mt-2 text-xs text-ink-soft">
            Чат для вопросов по заданию. <b>Ответы сюда не отправляются</b> — их сдают
            в кабинете, в блоке «Ответ команды».
          </p>
        )}
      </div>
    </Dialog>
