...
/** Кабинет команды шлёт это событие после успешной сдачи ответа, чтобы плашка и модалка
 *  дедлайна погасли сразу, а не висели «Поторопитесь сдать» поверх «Ответ отправлен». */
export const SUBMITTED_EVENT = 'mi:answer-submitted'
