...
export const CURRENT_TASK = {
  ...
  cases: [
    {
      id: 'c1',
      title: 'Блокировка карты на кассе — публичный конфуз',
      difficulty: 'Сложный',
      text: 'Клиент звонит в панике: его карту заблокировали прямо на кассе в супермаркете, при очереди. Считает это унизительным и грозится закрыть все счета. «Это просто позор! Меня поставили в неловкое положение перед людьми! Я требую объяснений и компенсации!»',
    },
    {
      id: 'c2',
      title: 'Скрытая комиссия — «вы воры!»',
      difficulty: 'Сложный',
      text: 'Клиент заметил списание комиссии, о которой, по его словам, его не предупреждали. Убеждён, что банк «тайно» снимает деньги, чувствует себя обманутым. «Вы воры! Сняли деньги без моего ведома! Я ничего не подписывал! Это мошенничество!»',
    },
    {
      id: 'c3',
      title: 'Перевод завис на двое суток',
      difficulty: 'Средний',
      text: 'Клиент сделал срочный перевод родственнику — деньги не пришли уже двое суток. Нервничает, считает банк некомпетентным. «Два дня деньги висят где-то в воздухе! Это что, 19-й век?! Я перестану пользоваться вашим банком!»',
    },
  ] as CaseItem[],
}
