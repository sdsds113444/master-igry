...
export const PRIZES = [
  ...
  { place: 'Все участники', emoji: '🐾', title: 'Коины за активность', text: 'Коины за участие в сезоне — обменяете на мерч в Альфа-маркете.', accent: '#ef3124', chipBg: '#c81e12', chipFg: '#ffffff' },
]
