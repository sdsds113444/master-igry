...
export const RULES = [
  ...
  // ВАЖНО: оценка ОДНА за все кейсы недели (0–3), а не за каждый кейс. Старая формулировка
  // «(по каждому кейсу)» заставляла команды ждать максимум 30 баллов за 10 кейсов и идти
  // к тренеру с вопросом «почему нам поставили 1 из 30».
  // «более 3 / менее 3» оставляли дырку ровно на 3 ошибках — а это не редкий край:
  // в первой неделе туда попали 3 команды из 11. Границы сведены встык.
  { icon: '⭐', title: 'Оценка кейсов', text: 'Одна общая оценка за все кейсы недели: 0 — не сдали · 1 — 4 и более ошибок · 2 — от 1 до 3 ошибок · 3 — без ошибок. Ошибка — кейс, где решение по существу не сложилось.' },
  { icon: '➕', title: 'Бонусы', text: 'Бонус +1 за нестандартное решение кейса. Супер-бонус +3 — команде с лучшим VOC недели. Максимум за неделю — 7 баллов.' },
